...
def get_filters():
    ...
    while (city not in cities):
        city = str(
            input("please enter 'chicago','new york city' or'washington' :")).lower().strip()
    ...
    while (month not in months):
        month = str(
            input("please enter a month from january to june :")).strip().lower()

    # get user input for day of week (all, monday, tuesday, ... sunday)
    days = ["all", "monday", "tuesday", "Wednesday",
            "Thursday", "friday", "saturday", "sunday"]
    day = str(input("please enter desired day or all : ")
              ).lower().strip()

    while (day not in days):
        day = str(input("please enter any weekday :")
                  ).lower().strip()
...
def time_stats(df):
    ...
    print("the most common day of week is {}".format(
...
def trip_duration_stats(df):
    ...
    print("total trip duration is {} seconds".format(
...
def user_stats(df):
    ...
    print("min is {} max is {} common is {}".format(
